...
const Us = () => {
    ...
    return (
        <section className={`${UsStyle.us} ${blur ? "" :UsStyle.active_blur} ${confirmation ? "": UsStyle.disaper}`}>
            ...
            {/*<span onClick={prevSlide}><img src="img/arrow_back_white.svg" alt="arrow_back" className={UsStyle.btn1}/></span>
                <img onClick={() => {setFullIMage(!fullImage)}} src={images[actualIndex]} alt="us_1"  className={`${UsStyle.image} ${fullImage ? UsStyle.active: ""}`}/>
                <CarouselPosition images={img} activeIndex={actualIndex} func={goToSlide}/>
                <span onClick={nextSlide}><img src="img/arrow_forward_white.svg" alt="arrow_forward" className={UsStyle.btn2}/></span> */} 
